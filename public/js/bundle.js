/******/ (() => {
  ...
  \****************************/
      /***/ (
        ...
        /* harmony import */ var _alerts__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./alerts */ './public/js/alerts.js');
        function _typeof(o) {
                      ...
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 3:
                          ...
                          if (res.data.status === 'success')
                            (0, _alerts__WEBPACK_IMPORTED_MODULE_0__.showAlert)(
                              'success',
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        axios__WEBPACK_IMPORTED_MODULE_1__['default'])({
                          method: 'GET',
                          url: '/api/v1/bookings/checkout-session/'.concat(
                            tourId,
                          ),
                        });
                      case 3:
  ...
  \****************************/
  __webpack_require__.r(__webpack_exports__);
  /* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_0__ =
    __webpack_require__(/*! ./login */ './public/js/login.js');
  /* harmony import */ var _stripe__WEBPACK_IMPORTED_MODULE_1__ =
    __webpack_require__(/*! ./stripe */ './public/js/stripe.js');
  /* harmony import */ var _updateSettings__WEBPACK_IMPORTED_MODULE_2__ =
    __webpack_require__(
  ...
  if (logoutButton)
    logoutButton.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _login__WEBPACK_IMPORTED_MODULE_0__.logout)();
    });
  if (userDataForm)
    userDataForm.addEventListener('submit', function (e) {
      ...
      (0, _updateSettings__WEBPACK_IMPORTED_MODULE_2__.updateSettings)(
        form,
        'data',
      );
    });
              ...
              while (1)
                switch ((_context.prev = _context.next)) {
                  case 0:
                    ...
                    _context.next = 7;
                    return (0,
                    _updateSettings__WEBPACK_IMPORTED_MODULE_2__.updateSettings)(
                      {
